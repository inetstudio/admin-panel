        ...
        Admin.containers.images[name] = new Vue({
            ...
            methods: {
                add: function (index) {
                    ...
                    tinymce.get(this.target).editorManager.execCommand('mceInsertContent', false, '<div class="article-block_img"><img src="' + this.images[index].src + '" alt="' + alt + '"><p class="fix">' + description + '</p></div>');
                },
                edit: function (index) {
