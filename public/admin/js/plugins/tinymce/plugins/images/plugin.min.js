...
tinymce.PluginManager.add('images', function(editor) {
    if ($(editor.getElement()).get(0).hasAttribute('hasImages')) {
        ...
        Admin.containers.images[name] = new Vue({
            ...
            methods: {
                add: function (index) {
                    tinymce.get(this.target).editorManager.execCommand('mceInsertContent', false, '<div class="article-block_img"><img src="' + this.images[index].src + '" alt="' + this.images[index].properties.alt + '"><p class="fix">' + this.images[index].properties.description + '</p></div>');
                },
                edit: function (index) {
        ...
        editor.addButton('images', {
            ...
            onclick: function () {
                ...
                Admin.modals.uploaderModal.inputs = JSON.parse($(editor.getElement()).attr('properties'));
